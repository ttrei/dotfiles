...
if configs_ok then
  ...
  -- Newer nvim-treesitter versions no longer expose nvim-treesitter.configs.
  -- Parsers are installed by Nix; start built-in Tree-sitter highlighting when a parser exists.
